            ...
            public void onClick(DialogInterface dialog, int which) {
                switch (which){
                    case 0:
                        ...
                        imageView = (CircularImageView) dialogView.findViewById(R.id.foto_profile);
                        ...
                        imageView.setImageURI(Uri.parse(cur.getString(cur.getColumnIndex(DBHelper.row_foto))));
